...
| `POST` | `/api/stores/scan` | **Синхронное** сканирование по городу/улице через API Магнита (~10-60 сек) |
...
### Сканирование
- Выполняется синхронно в рамках HTTP-запроса (не фоновая задача)
- API Магнита может возвращать дубликаты — они автоматически фильтруются по `store_code`
- Пагинация ограничена 20 страницами (защита от зацикливания)
